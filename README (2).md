...
<!--
  Add real photos of your finished hardware here! Easiest way:
  1. On GitHub.com, open this file for editing (pencil icon).
  2. Drag and drop your photo(s) directly into the text box below.
  3. GitHub uploads them automatically and inserts the correct markdown line.

  Or manually: put your images in an "images/" folder in this repo,
  then reference them like this:
  ![Kiosk front view](images/kiosk-front.jpg)
-->

*(Photos of the assembled kiosk go here)*
